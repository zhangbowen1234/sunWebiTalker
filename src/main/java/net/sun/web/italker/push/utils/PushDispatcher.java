package net.sun.web.italker.push.utils;
...
public class PushDispatcher {
    private static final String appId = "OlwSdfMhBmAEIW9o6tG4f4";
    private static final String appKey = "eTDnaDplbl6PnUaagcPAn8";
    private static final String masterSecret = "3CjuDDPwY39dF5NCodESM1";
